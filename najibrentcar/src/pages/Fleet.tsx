    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Koleksi lengkap mobil berkualitas tinggi dengan teknologi terkini
              untuk memenuhi berbagai kebutuhan perjalanan Anda
            </p>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <motion.div
            layout
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6 2xl:max-w-6xl max-w-7xl mx-auto"
          >
            <AnimatePresence>
